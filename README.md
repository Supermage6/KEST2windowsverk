...
crome, cpuid cpu-z, microsoft edge, recycle bin, cysco packet

What type of information is available on the Desktop and Taskbar?
apps,reseach bar, start menue, settings, languag,network and clock

Name a few applications listed in the Start Menu.
app list, explore, settings, file explorer, account settings, and power options

What are some of the available options?
pin and more

What are the available options in the Taskbar settings?
lock raskbar, automaticalli hide taskbar, in desctop and tablet mode, use small taskbar button, replace command prompt with windows powershell in the menue when i right click start button or press windows key+x, show badges on taskbar button, taskbar location on screen, combine taskbar buttons.

c. Task View is the native virtual
What are the available options in the Task View settings?
its the same setting as taskbar and the taskbar vie shows you all tabs you have on youre computer that is runing

What happened?
The aplications pens in both destops like normal

List some examples of system information below.
this is what it shows
![image](https://user-images.githubusercontent.com/55285659/226943787-8b44c148-f9c2-4c3b-9734-7ff5cfebb2df.png)


What are the behavior options for the icons?
the behavior of the icons is just on an off.

Click Turn system icons on or off. List the system icons that can be enabled.
there ar none its bc of were in windows 10 and we need windows 7 or 8 to do so.
